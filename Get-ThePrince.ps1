$feedUrl = "https://feeds.acast.com/public/shows/62cff2d9d455860013698a7f"
$outDir = $Global:PodcastPath + [IO.Path]::DirectorySeparatorChar + "The Prince"
...
foreach ($item in $xmlContent.rss.Channel.item) {
    ...
    # The Prince has two titles so I focus on the first one
